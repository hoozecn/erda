...
type Runtime struct {
	...
	Reserved1       string           `protobuf:"bytes,101,opt,name=reserved1,proto3" json:"reserved1,omitempty"`
}
...
func (x *Runtime) GetReserved1() string {
	if x != nil {
		return x.Reserved1
	}
	return ""
...
var file_runtime_proto_rawDesc = []byte{
	...
	0x31, 0x18, 0x65, 0x20, 0x01, 0x28, 0x09, 0x52, 0x09, 0x72, 0x65, 0x73, 0x65, 0x72, 0x76, 0x65,
	0x64, 0x31, 0x32, 0xc2, 0x02, 0x0a, 0x0e, 0x52, 0x75, 0x6e, 0x74, 0x69, 0x6d, 0x65, 0x53, 0x65,
